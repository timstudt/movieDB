...
class MovieDBAPITests: XCTestCase {
    ...
    func testDefaultConfig() {
        ...
        XCTAssert(defaultAPIClient.APIKey == MovieDBNetwork.Configuration.defaultAPIKey
            , "invalid api key init")
        XCTAssert(defaultAPIClient.baseURL == MovieDBNetwork.Configuration.defaultBaseURL
            , "invalid base URL init")
    }
